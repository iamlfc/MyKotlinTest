package iam.lfc.myapplication.Share;
...
public class Data {
    ...
    public static List<Data> get() {
        ...
        data1.pictureList = Arrays.asList(
                Uri.parse(Const.ImgTest1),
                Uri.parse(Const.ImgTest2),
                Uri.parse(Const.ImgTest3),
                Uri.parse(Const.ImgTest4),
                Uri.parse(Const.ImgTest5),
                Uri.parse(Const.ImgTest6),
                Uri.parse(Const.ImgTest7),
                Uri.parse(Const.ImgTest8),
                Uri.parse(Const.ImgTest9),
                Uri.parse(Const.ImgTest10),
                Uri.parse(Const.ImgTest11),
                Uri.parse(Const.ImgTest12)
